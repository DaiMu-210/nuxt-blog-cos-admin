  ...
  <section class="mx-auto max-w-[1080px]">
    <div class="mb-4 flex items-start justify-between gap-3">
      <div>
        ...
        <p class="mt-2 text-sm text-slate-500">本地管理端仅用于开发环境；静态部署到 COS 不包含 /admin。</p>
      </div>
    ...
    <div class="mb-4 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
      ...
      <div class="tw-card p-4">
        <div class="text-xs text-slate-500">草稿</div>
      ...
      <div class="tw-card p-4">
        <div class="text-xs text-slate-500">友链</div>
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-[1.2fr_0.8fr]">
      <section class="tw-card p-4">
        <div class="mb-3 flex items-baseline justify-between gap-2">
          ...
          <NuxtLink class="text-sm text-blue-600 hover:underline" to="/admin/posts">查看全部</NuxtLink>
        </div>
